...
export default function Hero() {
  ...
  return (
    <section id="hero" className="bg-white py-16 md:py-24 overflow-hidden">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <button
                ...
                className="bg-[#3ea789] text-white px-8 py-3.5 rounded-full font-semibold hover:bg-[#2f8f75] transition-all hover:scale-105 shadow-md flex items-center justify-center gap-2 group">
                Get Started
              ...
              <button
                ...
                className="border-2 border-slate-300 text-slate-700 px-8 py-3.5 rounded-full font-semibold hover:border-slate-800 hover:text-slate-800 transition-all flex items-center justify-center gap-2">
                <Play size={16} fill="currentColor" />
                View Demo
              </button>
            </div>

            <p className="text-sm text-slate-600 mt-8 pt-4 border-t border-slate-200">
              Designed for clinics and patients to manage waiting smarter
            </p>
          </div>

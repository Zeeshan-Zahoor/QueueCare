            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <button className="bg-[#3ea789] text-white px-5 py-2 rounded-full font-medium hover:bg-[#2f8f75] transition shadow-sm">
                            Get Started
                        </button>
                    </div>
                ...
                {mobileMenuOpen && (
                    <div className="md:hidden py-4 border-t border-slate-300 animate-fadeIn">
                        <div className="flex flex-col space-y-3">
                            <button className="text-slate-700 hover:text-slate-900 transition py-2 text-left">
                                Features
                            </button>
                            <button className="text-slate-700 hover:text-slate-900 transition py-2 text-left">
                                How it works
                            ...
                            <button className="bg-slate-800 text-white px-5 py-2 rounded-full font-medium text-center">
                                Get Started
                            </button>
                        </div>
                    </div>
